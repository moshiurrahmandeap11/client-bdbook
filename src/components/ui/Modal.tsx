  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "w-full bg-white/95 backdrop-blur-xl border border-slate-200/90 rounded-2xl sm:rounded-2xl shadow-2xl shadow-slate-300/40 overflow-hidden max-h-[90vh] flex flex-col animate-slideDown",
