  ...
  return (
    <div className="relative inline-block" ref={containerRef}>
      ...
      {open && (
        <div
          className={cn(
            "absolute mt-2 min-w-[12rem] p-1.5 bg-white/95 backdrop-blur-xl border border-slate-200/80 rounded-2xl shadow-xl shadow-slate-200/50 z-50 animate-fadeInDown",
