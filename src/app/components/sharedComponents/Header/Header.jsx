    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMenuOpen && (
          <div
            ref={mobileMenuRef}
            className="md:hidden absolute top-full left-0 right-0 mt-2 mx-4 rounded-2xl backdrop-blur-xl bg-black/70 border border-white/20 shadow-2xl overflow-hidden animate-slideDown"
          >
            <div className="py-3">
              {navItems.map((item) => {
                const isActive = pathname === item.href;
